...
//  map
//
//  Created by Максим Ялынычев on 21.03.2023.
//
...
class ViewController: UIViewController, MKMapViewDelegate, UIGestureRecognizerDelegate {
    ...
    lazy var makeRouteButton: UIButton = {
        ...
        button.setTitle(NSLocalizedString("Specify a route", comment: ""), for: .normal)
    ...
    override func viewDidLoad() {
        ...
        self.title = NSLocalizedString("title-Map", comment: "")
    ...
    @objc func buttonTapped() {
        let ac = UIAlertController(title: NSLocalizedString("Specify a route", comment: ""), message: NSLocalizedString("route-allert-loc", comment: ""), preferredStyle: .alert)
    ...
    private func setupConstraints() {
        ...
        NSLayoutConstraint.activate([
            ...
            makeRouteButton.leadingAnchor.constraint(equalTo: mapView.leadingAnchor, constant: 10),
            makeRouteButton.trailingAnchor.constraint(equalTo: mapView.trailingAnchor, constant: -10),
            makeRouteButton.bottomAnchor.constraint(equalTo: mapView.bottomAnchor, constant: -15),
            makeRouteButton.heightAnchor.constraint(equalToConstant: 40)
        ])
    }
